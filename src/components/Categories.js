        ...
        if (mobileWidth) {
                ...
                <Flex direction={{base: 'column', md: 'row'}} alignItems={{base: 'center'}} transition='ease 1000ms' position='relative' zIndex={1}>
                    {
                        categories.map((category) => {
                            if (window.location.pathname === category.link) return ( <>
                                ...
                                shadow='dark-lg' borderRadius="15" variant='outline' borderWidth={3} borderColor="#69009B" py={{base: 12, md: 8, lg: 12}} px={{base: 14, md: 10, lg: 14}}>
            ...
            return (
                <Flex direction={{base: 'column', md: 'row'}} alignItems={{base: 'center'}}>
                    <Skeleton shadow='dark-lg' height={100} width={200} borderRadius={15} startColor='#18003682' endColor='#180036dd' opacity={0.3}/>
